...
Solutions Engineer and Full-Stack Developer with 6+ years across enterprise cloud architecture, production platform reliability, and direct client delivery. Started building web applications early in my career, spent the core of it leading technical engagements for enterprise customers at IBM, and now run both sides through Sproutflow Studio.

Most of my work lives at the intersection of building things and explaining them. I like being close to the product and close to the customer at the same time.
...
- Design and ship production web applications using TypeScript, Next.js, React, and Supabase
- Design and operate Kubernetes-based cloud infrastructure across AWS, GCP, and IBM Cloud
- Build multi-agent AI systems and LLM-powered applications using Claude API, Gemini, Groq, and Ollama
...
**Solutions Engineering**:
Technical Discovery • POC Execution • Architecture Design • Customer Enablement • Stakeholder Engagement
...
**AI Development**:
Multi-Agent Systems • LLM System Architecture • Prompt Engineering • Claude API • Gemini • Groq • Ollama
